...
exp.info.algebraic = function(x,z,q){
  ...
  # function provided by Northrop and Coleman, computing the algebraic expected 
  # information matrix of the unpenalized negative log-likelihood of the 
  # multiple-threshold GP model
